...
public class TestApi {
    ...
    public void testSearch() {
        //"{"hlpretag":"<span class=\"s-fc7\">","hlposttag":"</span>","id":"32689809","s":"junbaor","type":"1002","offset":"0","total":"true","limit":"30","csrf_token":"5d2055cc7991877c678dbf55e61e8444"}"
        // type 1000 歌单 1002 用户 1009 电台
        //{"c":[{"id":"346089"}],"csrf_token":"","id":"346089","ids":["346089"]}
        // {"id":"346089","c":"[{id:346089}]","ids":"[346089]","csrf_token":""}
        // {"c":"[{\"id\":346089}]","csrf_token":"","id":346089,"ids":[346089]}
        String preData = "{\"c\":\"[{\\\"id\\\":346089}]\",\"csrf_token\":\"\",\"id\":346089,\"ids\":[346089]}";
        LOG.debug(preData);
        String data = "{\"id\":\"346089\",\"c\":\"[{id:346089}]\",\"ids\":\"[346089]\",\"csrf_token\":\"\"}";
        System.out.println(data);
        ParamVo paramVo = EncryptUtils.encrypt(data);
        Map<String,String> forms = JSON.parseObject(JSON.toJSONString(paramVo),Map.class);
                String url = "http://music.163.com/weapi/v3/song/detail";
        String text = Requests.post(url).headers(headers).forms(forms).send().readToText();
        LOG.debug(text);
    }
}
